...
class PaperData():
    def __init__(self) -> None:
        self.classified_items_json_path = r"D:\vscode_workspace\Data_Labeling\Database\classified_items_json.json"
        self.raw_items_path = r"D:\vscode_workspace\Data_Labeling\Database\raw_items.json"
        # 默认该文件的格式是{{},{},{}...}
